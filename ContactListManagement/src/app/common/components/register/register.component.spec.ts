...
import { CommonRegisterComponent } from './register.component';
...
describe('CommonRegisterComponent', () => {
  ...
  it('Instance created for common user register', async(() => {
    const fixture = TestBed.createComponent(CommonRegisterComponent);
