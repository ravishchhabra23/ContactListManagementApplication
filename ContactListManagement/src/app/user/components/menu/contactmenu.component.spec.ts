...
import { UserContactMenuComponent } from './contactmenu.component';
...
describe('UserContactMenuComponent', () => {
...
      ],
  ...
  it('Instance created for admin menu', async(() => {
    const fixture = TestBed.createComponent(UserContactMenuComponent);
