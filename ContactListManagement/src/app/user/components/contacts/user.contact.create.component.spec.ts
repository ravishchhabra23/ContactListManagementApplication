...
import { UserContactCreateComponent } from './user.contact.create.component';
...
describe('UserContactCreateComponent', () => {
...
      ],
  ...
  it('Instance created for user contact create', async(() => {
    const fixture = TestBed.createComponent(UserContactCreateComponent);
